...
```sh
git clone https://github.com/fzdwx/nvim.git ~/.config/nvim && cd ~/.config/nvim && git switch lua
```
...
**NOTE** Checkout this file for some predefined keymaps: [keymaps](https://github.com/fzdwx/nvim/blob/lua/lua/user/keymaps.lua)
